...
<body>
	...
	<nav class="auth-tabs" role="tablist" aria-label="會員選單">
      <button class="tab-button active" data-target="#login" role="tab" aria-selected="true">會員登入</button>
      <button class="tab-button" data-target="#register" role="tab" aria-selected="false">會員註冊</button>
      <button class="tab-button" data-target="#forgot" role="tab" aria-selected="false">忘記密碼</button>
    </nav>
     ...
     <section class="tab-panels">
      <form id="login" class="panel active" action="userServlet" method="POST" novalidate >
        ...
        <div class="field">
          ...
          <input id="login-password" name="password" type="password" placeholder="至少 6 碼" minlength="6" required>
      ...
      <form id="register" class="panel" novalidate>
        ...
        <div class="field">
          ...
          <input id="reg-name" name="name" type="text" placeholder="王小明" required>
        ...
        <div class="field">
          ...
          <input id="reg-password" name="password" type="password" placeholder="至少 6 碼" minlength="6" required>
          <p class="error" data-error-for="reg-password"></p>
        </div>
        <div class="field">
          <label for="reg-password2">確認密碼</label>
          <input id="reg-password2" name="password2" type="password" placeholder="再次輸入密碼" minlength="6" required>
